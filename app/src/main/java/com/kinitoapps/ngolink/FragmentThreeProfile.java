...
public class FragmentThreeProfile extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        view_pro = inflater.inflate(com.kinitoapps.ngolink.R.layout.profile_layout,container, false);
        profilePic=(CircleImageView) view_pro.findViewById(com.kinitoapps.ngolink.R.id.profile_pic);
        ...
        recyclerView=(RecyclerView)view_pro.findViewById(com.kinitoapps.ngolink.R.id.user_activity);
...
//                Log.v("msg postkey", String.valueOf(mDatabase.child(push_id).getKey()));
    ...
    public static class RecentActivityHolder extends RecyclerView.ViewHolder {
        ...
        public void setText(String text) {
            TextView post_title=(TextView)mView.findViewById(com.kinitoapps.ngolink.R.id.actionPerformedText);
        ...
        public void setImage(Context applicationContext, String imageLink) {
            final ImageView post_image=(ImageView) mView.findViewById(com.kinitoapps.ngolink.R.id.actionPerformedImage);
            Glide
