...
public class UpdateName extends AppCompatActivity {
 private EditText enterName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.kinitoapps.ngolink.R.layout.activity_update_name);
        ...
        findViewById(com.kinitoapps.ngolink.R.id.cancel).setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            findViewById(com.kinitoapps.ngolink.R.id.ok).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
